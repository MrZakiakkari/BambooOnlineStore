namespace BambooOnlineStore.Repositories.SQLite
{
	...
	{
		public UserAccountRepositoryComponent(DatabaseAgent databaseAgent, BambooOnlineStoreSqlStatements sqlStatements)
		{
		...
		private BambooOnlineStoreSqlStatements SqlStatements { get; set; }
	}
}